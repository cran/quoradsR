...
## Analyzing our quora  and quora Ads campaign data 

Now we can analyze our quora Ads data. For instance, let's compare the two campaings we have to see which one performed better the last 100 days. 
